...
## Issues
[Issues](https://github.com/shooter-dev/api_mangatheques/issues) est le canal idéal pour les rapports de bug, les nouvelles fonctionnalités ou pour soumètre une `pull requests`, cependant veuillez a bien respecter les restrictions suivantes :
